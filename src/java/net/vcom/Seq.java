...
public class Seq
{
    ...
    /**
     * This is the default constructor: it returns an empty Seq object.
     */
    public Seq()
    {}
     ...
     * Seq's valid() to call valid() on any subcomponents.
     *
     */
     ...
     * 0 and infinity.  (Although it would odd, the length could be zero.)
    ...
    /**
     * This method does a deep compare of the passed Seq to this Seq,
